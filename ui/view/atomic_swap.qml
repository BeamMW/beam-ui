...
ColumnLayout {
    ...
    property var offersStackView: StackView.view
    ...
    Component.onCompleted: {
        ...
        else if (atomicSwapLayout.shouldShowActiveTransactions) {
            atomicSwapLayout.state = "transactions";
    ...
    //% "Atomic Swaps"
    property string title:  qsTrId("atomic-swap-title")
                ...
                Component.onCompleted: {
                    transactionsTable.model.modelReset.connect(function(){
                        if (atomicSwapLayout.openedTxID != "") {
                            ...
                            var indexList = viewModel.transactions.match(index, SwapTxObjectList.Roles.TxID, atomicSwapLayout.openedTxID)
