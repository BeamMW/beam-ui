...
signals:
    ...
    void slatepackImportResult(bool ok, int errorCode, const QVariantMap& info);
...
private:
    ...
    void onSlatepackImportResult(bool ok, beam::wallet::slatepack::Error error, const beam::wallet::SlatepackEndpoint::ImportInfo& info) override;
