...
Для того, чтобы совершить онлайновый платеж, Вы должны выйти в Интернет в течение 12 часов после отправки монет.</translation>
    ...
    <message id="send-contract-only-fee">
        ...
        <translation>Вы будете платить только комиссию за транзакцию. Это может быть значительным для некоторых контрактов, поэтому пожалуйста, проверьте её.</translation>
    </message>
...
не могут быть отменены.</translation>
    ...
    <message id="send-spend-warning">
        ...
        <translation type="unfinished">Clicking confirm would spend funds</translation>
    </message>
